...
<body>
    <h1 style = "font-size: 45px; color:cornsilk; font-family: 'Copperplate Gothic Bold'; background: rgb(6, 141, 112);">FAQs</h1>
    <section>
        <div class="container">
            <div class="accordion">
                ...
                <div class="accordion-item" id="question4">
                    <a class="accordion-link" href="#question4">
                        What should I do when I have COVID-19 symptoms and when should I seek medical care?
                        <i class="icon ion-md-add"></i>
                        <i class="icon ion-md-remove"></i>
                    </a>
                    <div class="answer">
                ...
                <div class="accordion-item" id="question10">
                    ...
                    <div class="answer">
                        <p>
                            ...
                            <br>
                            7:Stay positive and energized by keeping in touch with loved ones by phone or online, and by exercising yourself. 
                        </p>
                    </div>
                </div>
